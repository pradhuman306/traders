...
import { dataFormatCSV, formatDate, priceFormatter , titleCase} from '../../actions/common';
        ...
        <div className="body-content">
            <div className="usermanagement-main">
                ...
                {props.transportRow.party ? <div><div className="datatable-filter-wrap">
                    ...
                    {transRentDetails.length ?        <div> <CSVLink 
                    data={dataFormatCSV(transRentDetails,titleCase(props.transportRow.party),'transportHistory')}
                    filename={`${props.transportRow.party?.replace(" ", "_")}.csv`}
