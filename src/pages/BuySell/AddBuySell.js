                                        ...
                                        <div className='row'>
                                            <div className='col-md-12'>
                                                <div className='group-field'>
                                                    <div>
                                                        <Field type="radio" id="buy" name="picked" value="One" onClick={(e)=>handleRadioChange("buy")} checked={isActive.buy} />
                                                        <label htmlFor='buy'>
                                                            Buy
                                                        </label>
                                                    </div>
                                                    <div>
                                                        <Field type="radio" id="sell" name="picked" value="Two" onClick={(e)=>handleRadioChange("sell")} checked={isActive.sell} />
                                                        <label htmlFor='sell'>
                                                            Sell
                                                        </label>
                                                    </div>
