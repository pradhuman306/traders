    ...
    function (t, r, o) {
      ...
      const s = function (e, t = !1) {
          ...
          for (const t in e)
            r.includes(e[t])
              ? delete e[t]
              : Array.isArray(e[t]) && (e[t].length || delete e[t]);
          return e;
        },
        d = function (e) {
          return ![
        ...
        p = (e) =>
          e.reduce((e, t) => e.concat(Array.isArray(t) ? p(t) : t), []),
          ...
          void 0 === e
            ...
            : [
                ...
                [
                  "node",
                  (e) =>
                    e instanceof window.Node || e instanceof window.HTMLElement,
                ],
                ["component", () => e && e.dom],
                [typeof e, () => !0],
              ].find((t) => t[1](e))[0],
        ...
        L = (e, t) => {
          ...
          for (const o in t)
            r.hasOwnProperty(o) &&
              (Array.isArray(t[o])
                ? (r[o] = Array.isArray(e[o]) ? E(e[o].concat(t[o])) : t[o])
                : "object" == typeof t[o]
                ? (r[o] = L(e[o], t[o]))
                : (r[o] = t[o]));
          return r;
        ...
        U = /^col-(xs|sm|md|lg)-([^\s]+)/,
        V = (e) =>
          e.split(" ").filter((e) => U.test(e) || e.startsWith("row-"));
      function Q(e) {
        const t = [
            "a",
            "an",
      ...
      class a {
        constructor(e, t) {
          ...
          e.id ||
            (e.name
              ? (e.id = e.name)
              : (e.id = "control-" + Math.floor(1e7 * Math.random() + 1))),
            (this.id = e.id),
            (this.type = e.type),
          ...
          (this.classConfig = jQuery.extend({}, a.controlConfig[o] || {})),
            ...
            this.required &&
              ((e.required = "required"), (e["aria-required"] = "true")),
    ...
    function (e, t) {
      ...
      e.exports = (function (e) {
        ...
        function (e, t, r) {
          ...
          function s(e) {
            return (
              null !== e && "object" === (void 0 === e ? "undefined" : o(e))
            );
          }
          function d(e) {
          ...
          function c(e, t) {
            if (null != e)
              if (
                ("object" !== (void 0 === e ? "undefined" : o(e)) && (e = [e]),
                a(e))
              )
              ...
              return (
                ...
                (e.prototype.loadLang = function (e) {
                  ...
                  return new Promise(function (o, n) {
                    if (-1 !== r.loaded.indexOf(e) && t)
                      return r.applyLanguage.call(r, r.langs[e]), o(r.langs[e]);
                ...
                (e.prototype.applyLanguage = function (e) {
                  var t =
                    ...
                    o = this.langs[e] || {};
                  return (
                    (this.langs[e] = Object.assign({}, o, t, r)), this.langs[e]
                  );
                }),
        ...
        function (e, t, r) {
          ...
          (a.prototype.request = function (e) {
            "string" == typeof e &&
              ...
              ((e = n.merge(o, { method: "get" }, this.defaults, e)).method =
    ...
    function (e, t, r) {
      ...
      const o = {},
        ...
        a = (e, t, r = !0) => {
          ...
          for (let r = e.length - 1; r >= 0; r--) {
            -1 !== e[r].textContent.toLowerCase().indexOf(t.toLowerCase())
      ...
      class c {
        ...
        onRender(e, t) {
          e.parentElement
            ? t(e)
            : window.requestAnimationFrame(() => this.onRender(e, t));
        }
      }
    },
    function (e, t, r) {
      function o(e) {
        ...
        return (
          "function" == typeof Event
            ? (t = new Event(e))
            : ((t = document.createEvent("Event")), t.initEvent(e, !0, !0)),
          t
        );
      }
      const n = {
        ...
        static register(e = {}, t = []) {
          ...
          for (const n of t) {
            ...
            if (!e[t]) {
              ...
              (i = n.datatype
                ? n.datatype
                : `${t}-${Math.floor(9e3 * Math.random() + 1e3)}`),
                (l.customRegister[i] = jQuery.extend(n, { type: t, class: e }));
            }
      ...
      function s(e, t) {
        for (var r = {}, o = [], n = 0; n < e.length; n++) {
          ...
          -1 !== u
            ...
            : l.push({ identifier: c, updater: h(f, t), references: 1 }),
            o.push(c);
        }
        return o;
      }
      ...
      class i {
        constructor(e, t) {
          (this.preview = t),
            (this.templates = {
              ...
              default: (e, t, r, o) => (
                r && t.appendChild(r),
                this.markup("div", [t, e], { className: n(o, e) })
              ),
              noLabel: (e, t, r, o) =>
                this.markup("div", e, { className: n(o, e) }),
              hidden: (e) => e,
            }),
        ...
        label() {
          ...
          return (
            this.data.required &&
              t.push(
                this.markup("span", "*", { className: "formbuilder-required" })
              ),
      ...
      class b extends n.a {
        ...
        build() {
          const e = [],
            ...
            f = "select" === i;
          if (
            ((d.multiple || "checkbox-group" === i) && (d.name = d.name + "[]"),
          ...
          if ((delete d.title, r)) {
            n &&
              f &&
              e.push(
                this.markup("option", n, { disabled: null, selected: null })
              );
            for (let t = 0; t < r.length; t++) {
              ...
              if (
                ...
                l && (r += "-inline"),
                  (u.type = c),
                  u.selected && ((u.checked = "checked"), delete u.selected);
              ...
              !0,
              {
                ...
                callbacks: {
                  ...
                  onStatusChange: (e, o, n) => {
                    ...
                    return (
                      r.val(l.join(", ")), { id: e, oldStatus: o, newStatus: n }
                    );
                  },
                },
      ...
      class x extends w {
        ...
        onRender(e) {
          ...
          if (
            ...
            const e = setTimeout(() => {
              window.tinymce.editors[this.id].setContent(
                this.parsedHtml(window.lastFormBuilderCopiedTinyMCE)
              ),
    ...
    function (e, t, r) {
      ...
      e.exports = function (e, t, r) {
        ...
        return (
          ...
          o(e, t, { leading: i, maxWait: t, trailing: l })
        );
      };
    },
    function (e, t, r) {
      ...
      class y {
        ...
        xmlSave(e) {
          ...
          t.forEach((e) => {
            ...
            if (l.e.includes(e.type)) {
              const e = t.map(
                (e) => Object(p.t)("option", e.label, e).outerHTML
              );
              n = n.concat(e);
            }
              ...
              i.length &&
                i.forEach((t) => {
                  ...
                  if (!i.hasClass("disabled-field")) {
                    ...
                    if (
                      ((l = Object.assign({}, l, n.getAttrVals(t))), l.subtype)
                    )
                      if ("quill" === l.subtype) {
                        const e = l.name + "-preview";
                        if (window.fbEditors.quill[e]) {
                          const t =
                            window.fbEditors.quill[e].instance.getContents();
                    ...
                    if (
                      ...
                      l.className &&
                        "true" == i.attr("addeddefaultcolumnclass") &&
                        1 ==
                          i
                            .closest(this.formBuilder.rowWrapperClassSelector)
                            .children().length &&
                        l.className.includes(m.a.opts.defaultGridColumnClass))
                    ) {
        ...
        save(e) {
          const t = this,
            ...
            n = {
              xml: (e) => t.xmlSave(o, e),
              json: (e) =>
                window.JSON.stringify(t.prepData(o), null, e && "  "),
            };
          return (
        ...
        closeConfirm(e, t) {
          e || (e = document.getElementsByClassName("form-builder-overlay")[0]),
            e && Object(l.f)(e),
            t ||
              (t = document.getElementsByClassName("form-builder-dialog")[0]),
            t && Object(l.f)(t),
        ...
        editorLayout(e) {
          return (
            {
              left: { stage: "pull-right", controls: "pull-left" },
              right: { stage: "pull-left", controls: "pull-right" },
            }[e] || ""
          );
        }
        showOverlay() {
            ...
            ? r.confirm(
                ...
                () => {
                  r.removeAllFields.call(r, n),
                    m.a.opts.persistDefaultFields && m.a.opts.defaultFields
                      ? this.addDefaultFields()
                      : m.a.opts.notify.success(i.allFieldsRemoved),
                    m.a.opts.onClearAll();
                },
                d
              )
        ...
        removeAllFields(e) {
          ...
          r.prepend && o.push(!0),
            r.append && o.push(!0),
            o.some(Boolean) ||
              (e.classList.add("empty"), (e.dataset.content = t.getStarted)),
            this.emptyStage(e);
        }
        emptyStage(e) {
            ...
            f = setTimeout(() => {
              ...
              o.tmpCleanPrevHolder(c).forEach((e) => {
                if (e.columnInfo.columnSize) {
                  d.attr("class") != e.columnInfo.columnSize &&
                    (d.attr(
                      "class",
        ...
        processSubtypes(e) {
          ...
          const r = b.a.getRegisteredSubtypes(),
            o = Object.entries(r).reduce(
              (e, [r, o]) => ((e[r] = (t[r] && Object(p.B)(t[r], o)) || o), e),
              {}
            ),
            n = {};
          for (const e in o)
          ...
          const l = [
            {
              ...
              events: { click: t.confirmRemoveAll.bind(t) },
            },
            {
              type: "button",
              label: "viewJSON",
              ...
              events: { click: t.showData.bind(t) },
            },
            {
              type: "button",
              id: "save",
        ...
        getFormData(e = "js", t = !1) {
          ...
          return {
            ...
            json: (e) =>
              window.JSON.stringify(r.prepData(r.d.stage), null, e && "  "),
          }[e](t);
        }
        ...
        tryParseColumnInfo(e) {
          ...
          if (e.className) {
            ...
            r &&
              ...
              r.forEach((e) => {
                e.startsWith("row-")
                  ? (t.rowNumber = parseInt(e.replace("row-", "").trim()))
                  : (t.columnSize = e);
              });
          }
          return t;
        ...
        showToast(t, r = 3e3) {
          null != this.toastTimer &&
            (window.clearTimeout(this.toastTimer), (this.toastTimer = null)),
        ...
        setupControls() {
          ...
          for (let e = 0; e < t.length; e++) {
            ...
            let o,
              n = h.a.lookup(r);
            if (n) o = n.class;
            else if (((n = {}), (o = b.a.getClass(r)), !o || !o.active(r)))
              continue;
            const i = n.icon || o.icon(r);
            let l = n.label || o.label(r);
            const a = i
              ? ""
              : n.iconClassName || "" + (w.a + r.replace(/-[\d]{4}$/, ""));
        ...
        orderFields(e) {
          ...
          return (
            window.sessionStorage &&
              (t.sortableControls
                ? (o = window.sessionStorage.getItem("fieldOrder"))
            ...
            o.forEach((e) => {
              ...
              if (e.match(t)) {
                ...
                -1 !== r &&
                  (o.splice(o.indexOf(e), 1), o.splice(r + 1, o.indexOf(e), e));
              }
            }),
      ...
      function I(e, t, r) {
            ...
            : M.sortable({
                ...
                update: function (t, r) {
                  ...
                  r.item.parent()[0] === b.stage
                    ...
                    : (A.setFieldOrder(M), (A.doCancel = !e.sortableControls));
                },
              }),
        ...
        const Y = (t) => {
            if (t[0].classList.contains("input-set-control")) {
              const r = [],
                o = e.inputSets.find(
                  (e) => Object(p.q)(e.name || e.label) === t[0].dataset.type
                );
              if (o && o.showHeader) {
                const e = {
                  type: "header",
        ...
        const K = function (t) {
          (t = A.getData(t)) && t.length
            ...
            (() => {
              const t = [],
                o = (t) =>
                  C("li", e[t], { className: "disabled-field form-" + t });
              return (
                e.prepend &&
                  !r(".disabled-field.form-prepend", b.stage).length &&
                  (t.push(!0), P.prepend(o("prepend"))),
                e.append &&
                  !r(".disabled-field.form-.append", b.stage).length &&
          ...
          const { type: r } = t,
            ...
            i = ((e) => {
              const t = [
                ...
                r = !["header", "paragraph", "file", "autocomplete"]
            ...
            l = {
              ...
              options: () =>
                (function (e) {
                  ...
                  if (r && r.length)
                    o = r.map((e) => Object.assign({}, { selected: !1 }, e));
                  else {
                    let e = [1, 2, 3];
                  ...
                  return (
                    i.push(u),
                    C("div", i, { className: "form-group field-options" })
                      .outerHTML
                  );
                })(t),
              requireValidOption: () =>
        ...
        function oe(e, t) {
          ...
          ["checkbox", "checkbox-group", "radio-group"].includes(l.type) ||
          ...
          return `<div class="form-group ${e}-wrap">${a}${`<div class="input-wrap">${(() => {
            if ("textarea" === l.type) {
              const e = l.value;
              return (
                delete l.value, `<textarea ${Object(p.b)(l)}>${e}</textarea>`
              );
            }
        ...
        const ie = (e, t, r = {}) => {
            const o = (t) =>
                C("label", t, { for: `${e}-${d.lastID}` }).outerHTML,
              n = {
                type: "checkbox",
                className: "fld-" + e,
                name: e,
            ...
            return (
              ...
              C("div", i.concat(l), { className: `form-group ${e}-wrap` })
                .outerHTML
            );
          },
          le = (e) => {
          ...
          se = (e, t, r) => {
            ...
            return C("div", [a, u], { className: `form-group ${i.name}-wrap` })
              .outerHTML;
          },
          de = (t, r, o = !1) => {
            const n = ["paragraph"];
            ...
            if (![].some((e) => !0 === e)) {
              ...
              "label" !== t || e.disableHTMLLabels
                ...
                : ((n.contenteditable = !0), (s += C("div", i, n).outerHTML));
              const u = `<div class="input-wrap">${s}</div>`;
              let f = o ? "none" : "block";
              "value" === t &&
                (f = r.subtype && "quill" === r.subtype && "none"),
                (s = C("div", [c, u], {
          ...
          ce = (e) => {
            ...
            let o = "";
            return (
              ["header", "paragraph", "button"].includes(t) && r.push(!0),
              r.some((e) => !0 === e) ||
                (o = ie("required", e, { first: c.a.get("required") })),
              o
            );
          },
          ue = function (t, i = !0) {
            ...
            m.push(C("label", Object(p.x)(s), { className: "field-label" })),
              m.push(
                C("span", " *", {
            ...
            const y = C(
                "div",
                [_(t), C("a", c.a.get("close"), { className: "close-field" })],
            ...
            if (
              ...
              W &&
                ...
                ("true" == H.attr("prepend")
                  ? r(t).prependTo(q)
                  : r(t).insertAfter("#" + H.attr("appendAfter"))),
                V || r(t).appendTo(q),
                W || P.append(q),
                O.appendTo(t),
                he(q),
            ...
            e.typeUserEvents[a] &&
              ...
              i &&
                (e.editOnAdd && (A.closeAllEdit(), A.toggleEdit(d.lastID, !1)),
                x.scrollIntoView &&
          ...
          Q() &&
            (r(t).sortable({
              ...
              receive: function (e, t) {
                ...
                if (
                  (i && o && ((U = !0), (W = !0), (H = r(t.item).parent())),
                  l && o)
                ) {
                  H = r(t.item).prev().hasClass("btnAddControl")
                    ? r(t.item).prev()
                    : r(t.item).next().hasClass("btnAddControl")
                    ? r(t.item).next()
        ...
        P.on(
          ...
          P.on("click touchstart", ".remove", (t) => {
            ...
            t.preventDefault();
            n.querySelector(".sortable-options").childNodes.length <= 2 &&
            !i.includes("checkbox")
          ...
          P.on("click touchstart", ".toggle-form, .close-field", function (e) {
            if ((e.stopPropagation(), e.preventDefault(), !0 === e.handled))
              return !1;
            {
          ...
          P.on("dblclick", "li.form-field", (e) => {
            if (
              ...
              (e.stopPropagation(), e.preventDefault(), !0 !== e.handled)
            ) {
              const t =
                "li" == e.target.tagName
                  ? r(e.target).attr("id")
                  : r(e.target).closest("li.form-field").attr("id");
              A.toggleEdit(t), (e.handled = !0);
            }
          }),
            ...
            (e.target.value = Object(p.A)(e.target.value)),
              "" === e.target.value
                ? r(e.target)
                    ...
                    .attr("placeholder", c.a.get("cannotBeEmpty"))
        ...
        function Ee(e, t = !1) {
          ...
          e.children("div" + T).each((e, o) => {
            const i = r("#" + o.id);
            t ||
            "true" != i.find("li").attr("manuallyChangedDefaultColumnClass")
        ...
        if (
          ...
          r(document).mousemove((e) => {
            je &&
              A.getDistanceBetweenPoints(ke, qe, e.pageX, e.pageY) >
          ...
          P.on("click", "input.fld-access", function (e) {
            ...
            t.slideToggle(250, function () {
              o.is(":checked") ||
                r("input[type=checkbox]", t).removeAttr("checked");
            });
          }),
          P.on("click", ".add-opt", function (e) {
            ...
            const a = r(".sortable-options", o),
              s = m.a.opts.onAddOption(
                { selected: !1, label: "", value: "" },
                { type: t, index: a.children().length, isMultiple: l }
              );
            a.append(Ae(s, l));
            let lengthOFli = a.children().length;
            let fieldId = jQuery(this)
            ...
            jQuery(this)
              .closest(".field-options")
              .children(".sortable-options-wrap")
              .children(".sortable-options")
              .children("li:nth-child(" + lengthOFli + ")")
              .append(
                '<div class="wrap-div"><input type="checkbox" data-attr="isDisplayInput" class="option-isDisplayInput option-attr" id="' +
                  fieldId +
                  "-" +
                  lengthOFli +
                  '"  /><label for="' +
                  ...
                  "-" +
                  lengthOFli +
                  '" class="input-display">Do you want to display Input field below this option?</label></div>'
              );
          }),
        ...
        return (
          ...
          (o.actions = {
            getFieldTypes: (t) =>
              t
                ? Object(p.B)(I.getRegistered(), e.disableFields)
                : I.getRegistered(),
              ...
              (Array.isArray(e) ? e : [e]).forEach((e) => {
                ["number", "string"].includes(typeof e) &&
                  ("number" == typeof e
                    ...
                    : /^frmb-/.test(e) || (e = b.stage.querySelector(e).id),
                  A.toggleEdit(e));
              });
            },
            toggleAllFieldEdit: () => {
                  ...
                  .then(() => {
                    t.each((e) => {
                      ...
                      jQuery(t[e]).data("formBuilder", r),
                        Object.assign(F, r.actions, { markup: p.t }),
